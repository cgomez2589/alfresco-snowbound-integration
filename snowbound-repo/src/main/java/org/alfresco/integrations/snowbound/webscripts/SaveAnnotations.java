 ...
 * Time: 10:35 PM
 */
public class SaveAnnotations extends AbstractWebScript {
    private static final Log logger = LogFactory.getLog(SaveAnnotations.class);
    ...
    private void createAnnotation(String annotationName,boolean redactionFlag, int permissionLevel, InputStream annotationInputStream){
        try{
            ...
            nodeService.addAspect(annotationNodeRef, ContentModel.ASPECT_HIDDEN, null);
